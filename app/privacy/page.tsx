          ...
          <div className="prose prose-lg max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                pragati – Personal Finance Management App ("we," "our," or "us") values your privacy. This Privacy
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                pragati does not use any third-party SDKs, analytics tools, or ad services. No personal information is
